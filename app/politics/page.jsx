    ...
    <main className='min-h-dvh '>
      <section className='lg:px-10 px-4 py-15 animate-[slideIn_.9s_ease-out]'>
        <div className='flex flex-col space-y-10'>
          <div className='flex items-center max-md:text-center flex-col  '>
          ...
          <motion.div
            ...
            viewport={{ once: false }} className='flex max-md:flex-col items-center gap-10'>
      ...
      <section className='bg-blue-200 py-15 px-4 lg:px-10'>
        <div className='space-y-7'>
          <div className='flex items-center flex-col max-md:text-center max-md:space-y-4 '>
      ...
      <section className='lg:px-10 px-4 py-15 min-h-dvh'>
        <motion.div initial={{ opacity: 0, scale: 0.9 }}
          ...
          viewport={{ once: false }} className='lg:grid grid-cols-2 gap-10 max-md:space-y-10 '>
          ...
          <div className='flex max-md:flex-col items-center  gap-4 lg:w-fit'>
            ...
            <div className='h-50 lg:w-75 flex items-center p-4 shadow-md rounded-lg border border-gray-300'>
